...
#ifndef PIXELGRAB_PLATFORM_MACOS_MAC_ANNOTATION_RENDERER_H_
#define PIXELGRAB_PLATFORM_MACOS_MAC_ANNOTATION_RENDERER_H_
...
/// macOS annotation renderer stub (CoreGraphics).
class MacAnnotationRenderer : public AnnotationRenderer {
 public:
  MacAnnotationRenderer() = default;
  ~MacAnnotationRenderer() override = default;
...
#endif  // PIXELGRAB_PLATFORM_MACOS_MAC_ANNOTATION_RENDERER_H_
